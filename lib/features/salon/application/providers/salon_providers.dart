...
final updateSalonControllerProvider =
    StateNotifierProvider<UpdateSalonController, AsyncValue<Salon?>>((ref) {
      return UpdateSalonController(ref.watch(salonRepositoryProvider));
    });
